    ...
    if (viewingProject) {
        return (
            <div>
                ...
                <style>{`.prose-content p{margin-bottom:16px}.prose-content h2{font-family:'Special Elite',monospace;font-size:20px;margin:28px 0 10px;border-bottom:1px solid #ddd;padding-bottom:6px}.prose-content h3{font-family:'Special Elite',monospace;font-size:16px;margin:20px 0 8px}.prose-content img{max-width:100%;border:2px solid ${accent};margin:16px 0;display:block}.prose-content iframe{width:100%;aspect-ratio:16/9;border:2px solid ${accent};margin:16px 0;border-radius:4px;display:block}.prose-content blockquote{border-left:4px solid ${accent};padding-left:16px;color:#666;font-style:italic;margin:16px 0}.prose-content ul{list-style-type:disc;padding-left:24px;margin-bottom:16px}.prose-content ol{list-style-type:decimal;padding-left:24px;margin-bottom:16px}.prose-content li{margin-bottom:4px}`}</style>
            </div>
        );
    }
